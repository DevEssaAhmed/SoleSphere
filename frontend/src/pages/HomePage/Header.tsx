    ...
    <div>
      <div className='flex pt-48 justify-center item-center container mx-auto '>
        <div className='section mt-8 '>
          ...
          <button className='mt-12 px-8 py-4 rounded-xl bg-primary text-white'>
            SHOP NOW
          </button>
        </div>
        <div className='section -mt-24 shoe-bg bg-opacity-10'>
      ...
      <div className='flex justify-evenly  mx-auto p-4 m-12 text-center container'>
        <div className='flex items-center '>
          <div className='w-16 h-16 flex items-center justify-center bg-primary rounded-md m-4'>
