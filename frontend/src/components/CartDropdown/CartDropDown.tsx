...
const CartDropDown = () => {
  ...
  const { cartItems, totalPrice, shippingPrice, taxPrice } = useAppSelector(
    (state) => state.cart
  );
              ...
              <div className='px-4  py-6 sm:px-8 sm:py-10 '>
                <div className='mt-6 space-y-3  border-b py-8'>
                  ...
                  <div className='flex items-center justify-between'>
                    ...
                    <p className='text-lg font-semibold text-gray-900'>${taxPrice}</p>
                  </div>
                  <div className='flex items-center justify-between'>
                    <p className='text-gray-400'>Shipping</p>
                    <p className='text-lg font-semibold text-gray-900'>${shippingPrice}</p>
                  </div>
                </div>
